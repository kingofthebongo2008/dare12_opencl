...
namespace freeform
{
    ...
    public:
        ...
        sample_application(const wchar_t* window_title, const imaging::opencl_texture& t, const opencl::command_queue* queue, const graphic::patch_draw_info& gdi, const graphic::transform_info& transform_info) : base(window_title)
