...
namespace freeform
{
    inline d3d11::itexture2d_ptr create_texture(ID3D11Device* device, const imaging::opencl_texture& t, const opencl::command_queue* queue )
    {
